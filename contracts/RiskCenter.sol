 ...
 * Markets should reference this contract as their riskManager.
 */
contract RiskCenter is RiskCenterAdminStorage, RiskManagerErrorReporter {
    ...
    */
    function _acceptImplementation() public returns (uint) {
        ...
        if (msg.sender != pendingRiskManagerImplementation || pendingRiskManagerImplementation == address(0)) {
